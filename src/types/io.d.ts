...
declare module 'socket.io-client' {
	...
	interface Emitter<
		 ...
		 * @return This Emitter
		 */
		on<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;

		/**
		 * @see on( event, fn )
		 */
		addEventListener<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;
		 ...
		 * @return This Emitter
		 */
		once<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;
		 ...
		 * @return This Emitter
		 */
		off<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;

		/**
		 * @see off( event, fn )
		 */
		removeListener<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;

		/**
		 * @see off( event, fn )
		 */
		removeEventListener<Ev extends ReservedOrUserEventNames<ReservedEvents, ListenEvents>>(event: Ev, fn: ReservedOrUserListener<ReservedEvents, ListenEvents, Ev>): this;

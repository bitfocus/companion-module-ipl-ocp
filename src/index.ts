		...
		switch (replicantName) {
			case 'activeRound':
				if (!isEmpty(this.socket.replicants[DASHBOARD_BUNDLE_NAME]['activeRound'])) {
					this.setVariable(
						'teams_alpha_score',
						String(this.socket.replicants[DASHBOARD_BUNDLE_NAME]['activeRound']?.teamA.score)
					)
					this.setVariable(
						'teams_bravo_score',
						String(this.socket.replicants[DASHBOARD_BUNDLE_NAME]['activeRound']?.teamB.score)
					)
					...
					this.setVariable(
						'games_in_set',
						String(this.socket.replicants[DASHBOARD_BUNDLE_NAME]['activeRound']?.games.length)
					)
